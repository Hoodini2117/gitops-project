...
Security was enhanced by implementing IAM Roles for Service Accounts (IRSA) using OIDC in EKS. This allowed Kubernetes workloads to securely access AWS services without using hardcoded credentials. Instead, temporary credentials are issued dynamically based on attached IAM policies, ensuring least-privilege access and improved security posture. Additionally, container images were scanned for vulnerabilities as part of the CI pipeline.
